...
@Component({
    selector: 'pdfviewer-layout',
    templateUrl: './pdfviewer-layout.component.html'
})
export class PDFViewerLayoutComponent implements AfterViewInit, OnInit, OnDestroy {
    ...
    constructor(public renderer: Renderer2, private menuService: MenuService, private primengConfig: PrimeNGConfig,
                public app: AppComponent, public loginService: AppLoginService) { }
